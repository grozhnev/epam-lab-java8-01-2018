    ...
    public void employersStuffList() {
        ...
        Map<String, Set<Person>> result = employees.stream()
                ...
                .collect(Collectors.groupingBy(
                        PersonEmployerPair::getEmployer, Collectors.mapping(PersonEmployerPair::getPerson, Collectors.toSet())
                ));
    ...
    public void greatestExperiencePerEmployer() {
        ...
        Map<String, Person> collect = employees.stream()
                .flatMap(e -> e.getJobHistory().stream()
                        .collect(Collectors.toMap(JobHistoryEntry::getEmployer, JobHistoryEntry::getDuration, Integer::sum))
                        .entrySet()
                        .stream()
                        .map(empDur -> new PersonEmployerDuration(e.getPerson(), empDur.getKey(), empDur.getValue())))
                .collect(Collectors.groupingBy(PersonEmployerDuration::getEmployer,
                        Collectors.collectingAndThen(
                                ...
                                ped -> ped.orElseThrow(NoSuchElementException::new).getPerson())));

        Map<String, Person> expected = new HashMap<>();
        expected.put("EPAM", employees.get(4).getPerson());

        // Иван Мельников and Александр Дементьев worked on google for 1 year
        // In my result expected is Иван Мельников, maybe it depends on JVM, idk
        // That's why I changed 1 to 0
